...
import ru.cbrrate.services.TelegramMessageProcessor;
...
public class KafkaConfig {
    ...
    public static final String GROUP_ID = "currencyRateBotResponseProvider";
    ...
    public void rateRequestListen(String msgAsString) {
        ...
        telegramMessageProcessor.processMessage(message);
    }
}
